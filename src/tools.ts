...
export interface ToolDefinition {
  ...
  output?: { schema: Record<string, unknown>; render: (args: Record<string, unknown>, value: unknown) => readonly unknown[] }
