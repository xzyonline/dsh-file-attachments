...
if (typeof document !== 'undefined' && document.getElementById('dsh-fa-attach-style') === null) {
  const tag = document.createElement('style')
  tag.id = 'dsh-fa-attach-style'
  tag.textContent = '.dsh-fa-attach:hover{background:var(--dsw-alias-interactive-bg-hover, rgba(128,128,128,0.14))}.dsh-fa-attach:active{transform:scale(0.96)}.dsh-fa-attach:disabled{opacity:0.5;cursor:default}'
